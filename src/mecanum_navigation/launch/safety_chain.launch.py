...
-> collision_monitor -> cmd_vel -> mecanum_drive_controller/reference.
...
def generate_launch_description():
    ...
    lifecycle_manager_smoother = Node(
        ...
        parameters=[{
            ...
            'autostart': autostart,
            # Cold CI runners can take longer than the Nav2 default while
            # Gazebo's renderer and all lifecycle nodes start together.
