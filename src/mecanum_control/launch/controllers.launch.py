...
def generate_launch_description():
    ...
    joint_state_broadcaster_spawner = Node(
        ...
        executable='spawner',
        arguments=[
            'joint_state_broadcaster', '--controller-manager-timeout', '30',
    ...
    # mecanum_drive_controller/reference -> cmd_vel remap'leri
    ...
    mecanum_drive_controller_spawner = Node(
        ...
        executable='spawner',
        arguments=[
            'mecanum_drive_controller', '--controller-manager-timeout', '30',
            '--param-file', controller_config,
        ],
        output='screen',
    )
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            default_value=PathJoinSubstitution([
                FindPackageShare('mecanum_control'), 'config', 'mecanum_controllers_sim.yaml'
            ]),
        ),
