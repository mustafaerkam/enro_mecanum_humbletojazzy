"""
Gazebo Harmonic baslatir, sim robotu (mecanum_robot_description
...
def _launch_setup(context, *args, **kwargs):
    ...
    # Kaynaktan overlay paketleri kullanildiginda plugin kutuphanelerini
    # Harmonic'in arama yoluna ekle.
...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            description="true ise 'gz sim -s' (sunucu-only, GUI yok)"),
