...
RPLIDAR A1M8 ayri terminalde `ros2 launch mecanum_bringup
rplidar_a1.launch.py` ile baslatilir; IMU ESP32 uzerinden micro-ROS ile gelir.
...
def generate_launch_description():
    ...
    # Jazzy controller_manager URDF'yi robot_state_publisher'in
    # /robot_description topic'inden alir; parametre olarak URDF verilmez.
    ...
    controller_manager = Node(
        ...
        parameters=[controller_manager_yaml, {'use_sim_time': False}],
        remappings=[
    ...
    controllers = IncludeLaunchDescription(
        ...
        launch_arguments={
            'use_sim_time': 'false',
            'controller_config': controller_manager_yaml,
        }.items(),
    )
    ...
    return LaunchDescription([
        ...
        LogInfo(msg=[
            "UYARI: micro_ros_agent ve RPLIDAR A1M8 driver'i bu launch tarafindan baslatilmiyor. ",
